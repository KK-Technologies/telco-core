// Converted from Kotlin: SubscriberDAOImpl.kt
 ...
 *
 */
public class SubscriberDAOImpl : SubscriberDAO {

    private final var logger by getLogger()

    private final var storage by lazy { getResource<ClientDataSource>() }
    private final var paymentProcessor by lazy { getResource<PaymentProcessor>() }
    private final var activation by lazy { getResource<Activation>() }

    //
    // Customer
    //

    override public void getCustomer(identity: Identity): Either<ApiError, Customer> {
        return try {
    ...
    override public void createCustomer(
            identity: Identity,
            customer: Customer,
            referredBy: Optional<String>): Either<ApiError, Customer> {
    ...
    override public void updateCustomer(identity: Identity, nickname: Optional<String>, contactEmail: Optional<String>): Either<ApiError, Customer> {
        try {
    ...
    override public void removeCustomer(identity: Identity): Either<ApiError, Unit> {
        return try {
    ...
    override public void getContext(identity: Identity): Either<ApiError, Context> {
        return try {
    ...
    // Regions
    //
    override public void getRegions(identity: Identity): Either<ApiError, Collection<RegionDetails>> {
        return try {
    ...
    override public void getRegion(identity: Identity, regionCode: String): Either<ApiError, RegionDetails> {
        return try {
    ...
    override public void getSubscriptions(identity: Identity, regionCode: Optional<String>): Either<ApiError, Collection<Subscription>> {
        return try {
    ...
    override public void getSimProfiles(identity: Identity, regionCode: String): Either<ApiError, Collection<SimProfile>> {
        return try {
    ...
    override public void provisionSimProfile(identity: Identity, regionCode: String, profileType: Optional<String>, alias: String): Either<ApiError, SimProfile> {
        return try {
    ...
    override public void updateSimProfile(identity: Identity, regionCode: String, iccId: String, alias: String): Either<ApiError, SimProfile> {
        return try {
    ...
    override public void markSimProfileAsInstalled(identity: Identity, regionCode: String, iccId: String): Either<ApiError, SimProfile> {
        return try {
    ...
    override public void sendEmailWithEsimActivationQrCode(identity: Identity, regionCode: String, iccId: String): Either<ApiError, SimProfile> {
        return try {
    ...
    override public void getBundles(identity: Identity): Either<ApiError, Collection<Bundle>> {
        return try {
    ...
    override public void getPurchaseHistory(identity: Identity): Either<ApiError, Collection<PurchaseRecord>> {
        return try {
    ...
    override public void getProducts(identity: Identity): Either<ApiError, Collection<Product>> {
        return try {
    ...
    override public void getProduct(identity: Identity, sku: String): Either<ApiError, Product> {
    ...
    override public void purchaseProduct(
            identity: Identity,
            sku: String,
            sourceId: Optional<String>,
            saveCard: Boolean): Either<ApiError, ProductInfo> {

        final var hadZeroBundle = hasZeroBundle(identity)
    ...
    private public void activate(identity: Identity) {
    ...
    private public void hasZeroBundle(identity: Identity) : Boolean {
    ...
    override public void createSource(identity: Identity, sourceId: String): Either<ApiError, SourceInfo> {
    ...
    override public void setDefaultSource(identity: Identity, sourceId: String): Either<ApiError, SourceInfo> {
        return storage.getCustomer(identity)
    ...
    override public void listSources(identity: Identity): Either<ApiError, List<SourceDetailsInfo>> {
        return storage.getCustomer(identity)
                .mapLeft { error -> mapStorageErrorToApiError(error.message, ApiErrorCode.FAILED_TO_FETCH_CUSTOMER_ID, error) }
                .flatMap { customer ->
                    paymentProcessor.getPaymentProfile(customerId = customer.id)
    ...
    override public void removeSource(identity: Identity, sourceId: String): Either<ApiError, SourceInfo> {
        return storage.getCustomer(identity)
                .mapLeft { error -> mapStorageErrorToApiError(error.message, ApiErrorCode.FAILED_TO_FETCH_CUSTOMER_ID, error) }
                .flatMap { customer ->
                    paymentProcessor.getPaymentProfile(customerId = customer.id)
    ...
    override public void getStripeEphemeralKey(identity: Identity, apiVersion: String): Either<ApiError, String> {
        return storage.getCustomer(identity)
                .mapLeft { error -> mapStorageErrorToApiError(error.message, ApiErrorCode.FAILED_TO_FETCH_CUSTOMER_ID, error) }
                .flatMap { customer ->
    ...
    override public void getReferrals(identity: Identity): Either<ApiError, Collection<Person>> {
        return try {
    ...
    override public void getReferredBy(identity: Identity): Either<ApiError, Person> {
        return try {
    ...
    override public void createNewJumioKycScanId(identity: Identity, regionCode: String): Either<ApiError, ScanInformation> {
    ...
    override public void getCountryCodeForScan(scanId: String): Either<ApiError, String> {
    ...
    override public void getScanInformation(identity: Identity, scanId: String): Either<ApiError, ScanInformation> {
    ...
    override public void getCustomerMyInfoData(identity: Identity, version: MyInfoApiVersion, authorisationCode: String): Either<ApiError, String> {
    ...
    override public void checkNricFinIdUsingDave(identity: Identity, nricFinId: String): Either<ApiError, Unit> {
    ...
    override public void saveAddress(identity: Identity, address: String, regionCode: String): Either<ApiError, Unit> {
    ...
    override public void storeApplicationToken(customerId: String, applicationToken: ApplicationToken): Either<ApiError, ApplicationToken> {
    ...
    private public void getNotificationToken(customerId: String, applicationId: String): Either<ApiError, ApplicationToken> {
        try {
