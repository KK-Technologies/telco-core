// Converted from Kotlin: ApplicationTokenResource.kt
...
public class ApplicationTokenResource(private final var dao: SubscriberDAO) {

    @EnableTracing
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public void storeApplicationToken(@Auth authToken: Optional<AccessTokenPrincipal>,
