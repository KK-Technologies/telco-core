// Converted from Kotlin: AppleIdAuthServiceEmulator.kt
...
@Path("/auth")
public class AppleIdAuthServiceEmulator {
    ...
    public void authorize(
        ...
        final var parts = clientSecret.split('.')
        assertEquals(3, parts.size)
        assertEquals("""{"kid":"KEY_ID","alg":"ES256"}""", String(Base64.getDecoder().decode(parts[0])))
        final var map: Map<String, String> = objectMapper.readValue(
