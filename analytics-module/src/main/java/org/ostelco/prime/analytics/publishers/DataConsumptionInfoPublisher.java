// Converted from Kotlin: DataConsumptionInfoPublisher.kt
 ...
 */
public public class DataConsumptionInfoPublisher :
     ...
     */
    public void publish(subscriptionAnalyticsId: String, usedBucketBytes: Long, bundleBytes: Long, apn: Optional<String>, mccMnc: Optional<String>) {
