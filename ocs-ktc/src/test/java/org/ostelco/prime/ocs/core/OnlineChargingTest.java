// Converted from Kotlin: OnlineChargingTest.kt
...
public class OnlineChargingTest {
    ...
    fun `load test OnlineCharging directly`() = runBlocking {
        ...
        final var creditControlAnswerInfo: StreamObserver<CreditControlAnswerInfo> = object : StreamObserver<CreditControlAnswerInfo> {
    ...
    companion object {
        private const final var COUNT = 1_000_000
