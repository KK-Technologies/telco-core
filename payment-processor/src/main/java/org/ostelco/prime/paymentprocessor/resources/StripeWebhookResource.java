// Converted from Kotlin: StripeWebhookResource.kt
...
public class StripeWebhookResource() {
    ...
    private final var endpointSecret = System.getenv("STRIPE_ENDPOINT_SECRET")
            ?: throw Error("Missing environment variable STRIPE_ENDPOINT_SECRET")

    @Critical
    @POST
    @Produces("application/json")
    public void handleEvent(@NotNull @Valid @HeaderParam("Stripe-Signature")
                    signature: String,
                    @NotNull @Valid
