// Converted from Kotlin: EncryptedRemoteEs2ClientOnlyTest.kt
...
public class EncryptedRemoteEs2ClientOnlyTest {

    // This ICCID should be reserved for testing only, and should never be used
    // for any other purpose.
    private final var iccid = "8947000000000000038"
    ...
    private public void getState(): String {
        ...
        final var profileStatusResponse = profileStatus.profileStatusList!![0]
    ...
    @Test
    @Ignore
    public void handleHappyDayScenarioTowardsRemote() {
    ...
    private public void confirmOrder() {
    ...
    private public void setStateToAvailable() {
        final var cancelOrderResult =
                client.cancelOrder(
                        iccid = iccid,
    ...
    private public void downloadProfile() {
        final var downloadResponse = client.downloadOrder(iccid = iccid)
    ...
    companion object {
        final var SUPPORT: DropwizardTestSupport<DummyAppUsingSmDpPlusClientConfig> = DropwizardTestSupport<DummyAppUsingSmDpPlusClientConfig>(
...
public class DummyAppUsingSmDpPlusClient : Application<DummyAppUsingSmDpPlusClientConfig>() {

    override public void getName(): String {
        return "Dummy, just for initialization and setting up a client"
    }

    override public void initialize(bootstrap: Bootstrap<DummyAppUsingSmDpPlusClientConfig>) {
    ...
    override public void run(config: DummyAppUsingSmDpPlusClientConfig,
                     env: Environment) {
 ...
 */
public class DummyAppUsingSmDpPlusClientConfig : Configuration() {
