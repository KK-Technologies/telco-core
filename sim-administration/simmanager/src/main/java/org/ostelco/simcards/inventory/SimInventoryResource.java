// Converted from Kotlin: SimInventoryResource.kt
...
public class SimInventoryResource(private final var api: SimInventoryApi) {

    @GET
    @Path("profileStatusList/{iccid}")
    @Produces(MediaType.APPLICATION_JSON)
    public void getSimProfileStatus(
    ...
    @Path("iccid/{iccid}")
    @Produces(MediaType.APPLICATION_JSON)
    public void findSimProfileByIccid(
            @NotEmpty @PathParam("hssName") hssName: String,
            @NotEmpty @PathParam("iccid") iccid: String): Response =
    ...
    @Path("imsi/{imsi}")
    @Produces(MediaType.APPLICATION_JSON)
    public void findSimProfileByImsi(
            @NotEmpty @PathParam("hssName") hssName: String,
    ...
    @Path("msisdn/{msisdn}")
    @Produces(MediaType.APPLICATION_JSON)
    public void findSimProfileByMsisdn(
            @NotEmpty @PathParam("hssName") hssName: String,
    ...
    @Path("esim")
    @Produces(MediaType.APPLICATION_JSON)
    public void allocateNextEsimProfile(
            @NotEmpty @PathParam("hssName") hssName: String,
    ...
    public void importBatch(
        ...
        final var unknownQueryParameters = context.queryParameters.keys.subtract(listOf("initialHssState"))
        ...
        //     it is impossible to infer the type of the return public public class by observing the typing of the
    ...
    private public void error(description: String, code: ApiErrorCode, error: SimManagerError): Response.ResponseBuilder {
        final var apiError = mapSimManagerErrorToApiError(description, code, error)
