// Converted from Kotlin: SimInventoryDBWrapperImpl.kt
...
public class SimInventoryDBWrapperImpl(private final var db: SimInventoryDB) : SimInventoryDBWrapper {


    override public void getHssProfileNamePairs(): Either<SimManagerError, List<HssProfileIdName>> =
            either(NotFoundError("Could not determine list of HSS profile name pairs")) {
                final var hssProfileNamePairs = db.getHssProfileNamePairs()
                hssProfileNamePairs
            }
    ...
    override public void getSimProfileById(id: Long): Either<SimManagerError, SimEntry> =
            either(NotFoundError("Found no SIM for id " + id + "")) {
                db.getSimProfileById(id)
            }

    override public void getSimProfileByIccid(iccid: String): Either<SimManagerError, SimEntry> =
            either(NotFoundError("Found no SIM for ICCID " + iccid + "")) {
                db.getSimProfileByIccid(iccid)
            }

    override public void getSimProfileByImsi(imsi: String): Either<SimManagerError, SimEntry> =
            either(NotFoundError("Found no SIM for IMSI " + imsi + "")) {
                db.getSimProfileByImsi(imsi)
            }

    override public void getSimProfileByMsisdn(msisdn: String): Either<SimManagerError, SimEntry> =
            either(NotFoundError("Found no SIM MSISDN " + msisdn + "")) {
                db.getSimProfileByMsisdn(msisdn)
            }

    override public void findNextNonProvisionedSimProfileForHss(hssId: Long, profile: String): Either<SimManagerError, SimEntry> =
    ...
    // err
    override public void findNextReadyToUseSimProfileForHss(hssId: Long, profile: String): Either<SimManagerError, SimEntry> =
    ...
    @Transaction
    override public void setEidOfSimProfileByIccid(iccid: String, eid: String): Either<SimManagerError, SimEntry> =
    ...
    @Transaction
    override public void setEidOfSimProfile(id: Long, eid: String): Either<SimManagerError, SimEntry> =
    ...
    @Transaction
    override public void setHssState(id: Long, state: HssState): Either<SimManagerError, SimEntry> =
    ...
    @Transaction
    override public void setProvisionState(id: Long, state: ProvisionState): Either<SimManagerError, SimEntry> =
    ...
    @Transaction
    override public void setSmDpPlusState(id: Long, state: SmDpPlusState): Either<SimManagerError, SimEntry> =
    ...
    @Transaction
    override public void setSmDpPlusStateUsingIccid(iccid: String, state: SmDpPlusState): Either<SimManagerError, SimEntry> =
    ...
    @Transaction
    override public void setSmDpPlusStateAndMatchingId(id: Long, state: SmDpPlusState, matchingId: String): Either<SimManagerError, SimEntry> =
    ...
    override public void findSimVendorForHssPermissions(profileVendorId: Long, hssId: Long): Either<SimManagerError, List<Long>> =
    ...
    override public void storeSimVendorForHssPermission(profileVendorId: Long, hssId: Long): Either<SimManagerError, Int> =
            either {
-                db.storeSimVendorForHssPermission(profileVendorId, hssId)
            }

    override public void addHssEntry(name: String): Either<SimManagerError, Int> =
            either {
                db.addHssAdapter(name)
            }

    override public void getHssEntryByName(name: String): Either<SimManagerError, HssEntry> =
            either(NotFoundError("Found no HSS entry  with metricName " + name + "")) {
                db.getHssEntryByName(name)
            }

    override public void getHssEntryById(id: Long): Either<SimManagerError, HssEntry> =
            either(NotFoundError("Found no HSS entry  with id " + id + "")) {
                db.getHssEntryById(id)
            }

    override public void addProfileVendorDatumAdapter(name: String): Either<SimManagerError, Int> =
            either {
                db.addProfileVendorAdapter(name)
            }

    override public void getAllProfileVendors(): Either<SimManagerError, List<ProfileVendorAdapterDatum>> =
    ...
    override public void getProfileVendorAdapterDatumByName(name: String): Either<SimManagerError, ProfileVendorAdapterDatum> =
            either(NotFoundError("Found no SIM profile vendor with metricName " + name + "")) {
                db.getProfileVendorAdapterByName(name)
            }

    override public void getProfileVendorAdapterDatumById(id: Long): Either<SimManagerError, ProfileVendorAdapterDatum> =
    ...
    override public void createNewSimImportBatch(importer: String, hssId: Long, profileVendorId: Long): Either<SimManagerError, Int> =
            either {
                db.createNewSimImportBatch(importer, hssId, profileVendorId)
            }

    override public void updateBatchState(id: Long, size: Long, status: String, endedAt: Long): Either<SimManagerError, Int> =
            either {
                db.updateBatchState(id, size, status, endedAt)
            }

    override public void getBatchInfo(id: Long): Either<SimManagerError, SimImportBatch> =
     ...
     */
    override public void lastInsertedRowId(): Either<SimManagerError, Long> =
            either {
     ...
     */
    override public void getHssEntries(): Either<SimManagerError, List<HssEntry>> =
     ...
     * a particular HSS.
     */
    override public void getProfileNamesForHssById(hssId: Long): Either<SimManagerError, List<String>> =
     ...
     */
    override public void getProfileStatsAsKeyValuePairs(hssId: Long, simProfile: String): Either<SimManagerError, List<KeyValuePair>> =
    ...
    private fun <R> either(error: SimManagerError, action: () -> Optional<R>): Either<SimManagerError, R> =
            try {
