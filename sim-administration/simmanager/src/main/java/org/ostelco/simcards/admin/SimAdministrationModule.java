// Converted from Kotlin: SimAdministrationModule.kt
...
public class SimAdministrationModule : PrimeModule {
    ...
    override public void init(env: Environment) {
        ...
        final var dispatcher = makeHssDispatcher(
        ...
        final var hssAdapters = SimManagerToHssDispatcherAdapter(
    ...
    //     via config.
    private public void makeHssDispatcher(
            hssAdapterConfig: Optional<HssAdapterConfig>,
        ...
        when {
            ...
            hssVendorConfigs.isNotEmpty() -> {
                ...
                final var dispatchers = mutableSetOf<HssDispatcher>()
...
public void isLowerCase(str: String): Boolean {
...
public public class ResourceRegistry {
    lateinit var simInventoryResource: SimInventoryResource
}

public public class ApiRegistry {
    lateinit var simInventoryApi: SimInventoryApi
    final var simProfileStatusUpdateListeners = mutableSetOf<(iccId: String, status: SimProfileStatus) -> Unit>()
}
