// Converted from Kotlin: SimAdministrationApplication.kt
 ...
 */
public class SimAdministrationApplication : Application<SimAdministrationConfiguration>() {


    private final var simAdminModule =  SimAdministrationModule()
    ...
    override public void initialize(bootstrap: Bootstrap<SimAdministrationConfiguration>) {
    ...
    override public void run(config: SimAdministrationConfiguration,
                     env: Environment) {
        simAdminModule.setConfig(config)
        simAdminModule.init(env)
    }

    public void getDAO() =  simAdminModule.getDAO()
