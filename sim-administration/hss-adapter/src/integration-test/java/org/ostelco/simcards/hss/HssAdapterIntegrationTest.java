// Converted from Kotlin: HssAdapterIntegrationTest.kt
 ...
 **/
public class HssAdapterIntegrationTest {
    ...
    public void testSuspensionUsingGrpc() {
        ...
        assertTrue(hssApplication.isActivated(ICCID))
        final var response = adapter.suspend(hssName = HSS_NAME, iccid = ICCID)
