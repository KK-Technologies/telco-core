// Converted from Kotlin: Neo4jLoadTest.kt
...
public class Neo4jLoadTest {
    ...
    companion object {
        ...
        const final var COUNT = 10_000
        const final var USERS = 100

        const final var USED = 10L
        const final var REQUESTED = 100L

        const final var NAME = "Test User"
        const final var COUNTRY_CODE = "no"
...
public void Int.GiB() = this.toLong() * 1024 * 1024 * 1024
