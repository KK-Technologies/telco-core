// Converted from Kotlin: Registry.kt
...
public public class EntityRegistry {

    private final var entityTypeMap = mutableMapOf<KClass<out HasId>, EntityType<out HasId>>()
    ...
    fun <E : HasId> getEntityType(kClass: KClass<E>): EntityType<E> {
        return (entityTypeMap as MutableMap<KClass<E>, EntityType<E>>).getOrPut(kClass) {
            final var entityType = EntityType(kClass.java)
