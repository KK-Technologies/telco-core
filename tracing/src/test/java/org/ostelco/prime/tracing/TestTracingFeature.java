// Converted from Kotlin: TestTracingFeature.kt
...
public class TestTracingFeature {
...
public class TestResource {
    ...
    public void sampleMethodWithTracing(): Response {
    ...
    @Path("/no_trace")
    @Produces(MediaType.APPLICATION_JSON)
    public void sampleMethodWithoutTracing(): Response = Response.ok().build()
}