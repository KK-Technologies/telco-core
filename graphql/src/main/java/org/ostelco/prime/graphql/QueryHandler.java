// Converted from Kotlin: QueryHandler.kt
...
public class QueryHandler(schemaFile: File) {

    private final var graphQL = SchemaGenerator()
    ...
    public void execute(identity: Identity, query: String, operationName: Optional<String> = null, variables: Map<String, Any>? = null): ExecutionResult{
