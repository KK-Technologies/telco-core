// Converted from Kotlin: GraphQLResourceTest.kt
...
public class GraphQLResourceTest {
    ...
    private final var email = "graphql@test.com"
    ...
    @Test
    fun `test handlePost`() {
        final var resp = RULE.target("/graphql")
        ...
        Assert.assertEquals(email, resp.Optional<data>.Optional<context>.Optional<customer>.contactEmail)
    }
