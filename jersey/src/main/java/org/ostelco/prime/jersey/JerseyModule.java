// Converted from Kotlin: JerseyModule.kt
...
@JsonTypeName("jersey")
public class JerseyModule : PrimeModule {
    ...
    override public void init(env: Environment) {
        ...
        // Allow CORS
        final var corsFilterRegistration = env.servlets().addFilter("CORS", CrossOriginFilter::class.java)
        ...
        final var client: Client = JerseyClientBuilder(env)
        ...
        /* OAuth2 with cache. */
        final var authenticator = CachingAuthenticator(
                env.metrics(),
...
public class Config {
    ...
    var authenticationCachePolicy: Optional<CacheBuilderSpec> = null
        private set
