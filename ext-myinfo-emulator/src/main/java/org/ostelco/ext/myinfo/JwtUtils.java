// Converted from Kotlin: JwtUtils.kt
...
public public class JwtUtils {

    public void createAccessToken(signingPrivateKey: String): String {
    ...
    public void getClaims(accessToken: String, signingPublicKey: String) = Jwts.parser()
    ...
    public void createJws(signingPrivateKey: String, payload: String): String {
        return Jwts.builder()
