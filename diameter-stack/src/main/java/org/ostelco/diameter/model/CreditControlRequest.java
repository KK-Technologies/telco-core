// Converted from Kotlin: CreditControlRequest.kt
...
public class CreditControlRequest {
    ...
    var ccRequestType: Optional<Avp> = null

    @AvpField(Avp.CC_REQUEST_NUMBER)
    var ccRequestNumber: Optional<Avp> = null

    @AvpField(Avp.ORIGIN_HOST)
    var originHost: Optional<String> = ""

    @AvpField(Avp.ORIGIN_REALM)
    var originRealm: Optional<String> = ""
}
