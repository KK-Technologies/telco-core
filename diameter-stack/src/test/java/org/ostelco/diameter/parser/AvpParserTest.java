// Converted from Kotlin: AvpParserTest.kt
...
public class AvpParserTest {

    private final var VENDOR_ID_3GPP = 10415L

    @Test
    public void parsePsInformation() {
        final var calledStationIdAvp = Mockito.mock(Avp::class.java)
        final var sgsnMccMncAvp = Mockito.mock(Avp::class.java)
    ...
    @Test
    public void parseServiceUnit() {

        final var total = Mockito.mock(Avp::class.java)
        final var input = Mockito.mock(Avp::class.java)
        final var output = Mockito.mock(Avp::class.java)
        ...
        final var serviceUnit = AvpParser().parse(ServiceUnit::class, set)
