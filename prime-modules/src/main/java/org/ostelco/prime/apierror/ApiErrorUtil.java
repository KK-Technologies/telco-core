// Converted from Kotlin: ApiErrorUtil.kt
...
public void Either<ApiError, Any>.responseBuilder(success: Response.Status = Response.Status.OK,
...
public void Either<ApiError, Any>.responseBuilder(payload: String,
