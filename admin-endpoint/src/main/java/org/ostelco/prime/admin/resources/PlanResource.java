// Converted from Kotlin: PlanResource.kt
...
public class PlanResource {
    ...
    public void get(@NotNull
        ...
        return storage.getPlan(planId).fold(
                {
                    final var err = ApiErrorMapper.mapStorageErrorToApiError("Failed to fetch plan",
    ...
    public void create(createPlanRequest: CreatePlanRequest): Response {
        return storage.createPlan(
                ...
                {
                    final var err = ApiErrorMapper.mapStorageErrorToApiError("Failed to store plan",
    ...
    public void delete(@NotNull
        ...
        return storage.deletePlan(planId).fold(
                {
                    final var err = ApiErrorMapper.mapStorageErrorToApiError("Failed to remove plan",
