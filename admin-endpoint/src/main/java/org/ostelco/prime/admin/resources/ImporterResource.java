// Converted from Kotlin: ImporterResource.kt
 ...
 */
@Path("/import")
public class ImporterResource(private final var processor: ImportProcessor) {
    ...
    public void createOffer(createOffer: CreateOffer): Response {
    ...
    @Path("/segments")
    @Consumes("text/vnd.yaml")
    public void createSegment(createSegments: CreateSegments): Response {
    ...
    @Path("/segments")
    @Consumes("text/vnd.yaml")
    public void importSegment(updateSegments: UpdateSegments): Response {
    ...
    @Consumes("text/vnd.yaml")
    public void importSegment(addToSegments: AddToSegments): Response {
    ...
    @Path("/segments/subscribers")
    @Consumes("text/vnd.yaml")
    public void importSegment(removeFromSegments: RemoveFromSegments): Response {
    ...
    @Path("/segments/subscribers")
    @Consumes("text/vnd.yaml")
    public void importSegment(changeSegments: ChangeSegments): Response {
