// Converted from Kotlin: PaymentTransactionResource.kt
...
public class PaymentTransactionResource {
    ...
    @GET
    @Path("/transactions")
    public void fetchPaymentTransactions(@QueryParam("start")
    ...
    @GET
    @Path("/purchases")
    public void fetchPurchaseTransactions(@QueryParam("start")
                                  @DefaultValue("-1")
                                  start: Long,
                                  @QueryParam("end")
                                  @DefaultValue("-1")
    ...
    @GET
    @Path("/check")
    public void checkTransactions(@QueryParam("start")
                          @DefaultValue("-1")
                          start: Long,
                          @QueryParam("end")
                          @DefaultValue("-1")
    ...
    private public void failed(error: StoreError, code: ApiErrorCode): Response.ResponseBuilder =
    ...
    companion object {
        ...
        final var A_DAY_AGO: Long = -86400L
    }
}
