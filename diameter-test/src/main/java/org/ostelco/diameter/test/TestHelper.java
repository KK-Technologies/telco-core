// Converted from Kotlin: TestHelper.kt
...
/**
 * Helper public class to create the most common AVP combinations
 * for a Diameter Credit-Control Application.
 */
public public class TestHelper {

    private const final var VENDOR_ID_3GPP = 10415L
    private const final var IMSI = "242017100000228"
    private const final var APN = "panacea"
    private const final var SGSN_MCC_MNC = "24201"
    private const final var CALLED_STATION_ID = 30

    private public void buildBasicRequest(ccrAvps: AvpSet, requestType: Int, requestNumber: Int) {
    ...
    private public void addUser(ccrAvps: AvpSet, msisdn: String, imsi: String) {
    ...
    private public void addBucketRequest(ccrAvps: AvpSet, ratingGroup: Int, serviceIdentifier: Int, requestedBucketSize: Long, usedBucketSize: Long = 0, ccTime: Long = 0, ccServiceSpecificUnits: Long = 0, reportingReason: ReportingReason = ReportingReason.QUOTA_EXHAUSTED) {
    ...
    private public void addFinalBucketRequest(ccrAvps: AvpSet, ratingGroup: Int, serviceIdentifier: Int, usedBucketSize: Long = 0) {
    ...
    private public void addTerminateRequest(ccrAvps: AvpSet, ratingGroup: Int, serviceIdentifier: Int, usedBucketSize: Long) {
    ...
    private public void addServiceInformation(ccrAvps: AvpSet, apn: String, sgsnMccMnc: String) {
    ...
    @JvmStatic
    public void addUnknownApv(ccrAvps: AvpSet) {
        set(ccrAvps) {
    ...
    @JvmStatic
    public void createInitRequest(ccrAvps: AvpSet, msisdn: String) {
    ...
    @JvmStatic
    public void createInitRequest(ccrAvps: AvpSet, msisdn: String, requestedBucketSize: Long, ratingGroup: Int, serviceIdentifier: Int) {
        buildBasicRequest(ccrAvps, RequestType.INITIAL_REQUEST, requestNumber = 0)
        addUser(ccrAvps, msisdn = msisdn, imsi = IMSI)
    ...
    @JvmStatic
    public void createInitRequestMultiRatingGroups(ccrAvps: AvpSet, msisdn: String, requestedBucketSize: Long) {
        buildBasicRequest(ccrAvps, RequestType.INITIAL_REQUEST, requestNumber = 0)
        addUser(ccrAvps, msisdn = msisdn, imsi = IMSI)
    ...
    @JvmStatic
    public void createUpdateRequest(ccrAvps: AvpSet, msisdn: String, requestedBucketSize: Long, usedBucketSize: Long, ratingGroup: Int, serviceIdentifier: Int, reportingReason: ReportingReason) {
    ...
    @JvmStatic
    public void createUpdateRequest(ccrAvps: AvpSet, msisdn: String, requestedBucketSize: Long, usedBucketSize: Long, ratingGroup: Int, serviceIdentifier: Int, ccTime: Long, ccServiceSpecificUnits: Long) {
        buildBasicRequest(ccrAvps, RequestType.UPDATE_REQUEST, requestNumber = 1)
        addUser(ccrAvps, msisdn = msisdn, imsi = IMSI)
    ...
    @JvmStatic
    public void createUpdateRequestFinal(ccrAvps: AvpSet, msisdn: String, usedBucketSize: Long, ratingGroup: Int, serviceIdentifier: Int) {
        buildBasicRequest(ccrAvps, RequestType.UPDATE_REQUEST, requestNumber = 1)
        addUser(ccrAvps, msisdn = msisdn, imsi = IMSI)
    ...
    @JvmStatic
    public void createTerminateRequest(ccrAvps: AvpSet, msisdn: String, usedBucketSize: Long, ratingGroup: Int, serviceIdentifier: Int) {
    ...
    @JvmStatic
    public void createTerminateRequest(ccrAvps: AvpSet, msisdn: String) {
        buildBasicRequest(ccrAvps, RequestType.TERMINATION_REQUEST, requestNumber = 2)
        addUser(ccrAvps, msisdn = msisdn, imsi = IMSI)
        addServiceInformation(ccrAvps, apn = APN, sgsnMccMnc = SGSN_MCC_MNC)
    }
