// Converted from Kotlin: TestUser.kt
...
public void createCustomer(name: String, email: String): Customer {
...
public void createSubscription(email: String): String {

    final var msisdn = RandomStringUtils.randomNumeric(8,9)
...
public void enableRegion(email: String, region: String = "no") {
...
private public void performJumioKyc(email: String, region: String) {

    final var scanInformation = post<ScanInformation> {
...
private final var random = Random()
public void randomInt(): Int = random.nextInt(99999)